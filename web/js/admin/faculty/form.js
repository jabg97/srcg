...
$(".error").remove();$(".error2").remove();$(".error3").remove();
	if(validar(cod,col,nom)){
			...
			function validar(cod,col,nom){
				...
				if( cod == "" ){
	$(".error_div").focus().after(" <div class='error alert bg-danger text-white z-depth-4 hoverable imen'><center><strong> <i class='fa fa-exclamation-circle left'></i>&nbsp;&nbsp;Error!</strong> Escriba el codigo de la facultad.</center></div>");
			return false;
	...
	$(".error2_div").focus().after(" <div class='error2 alert bg-danger text-white z-depth-4 hoverable imen'><center><strong> <i class='fa fa-exclamation-circle left'></i>&nbsp;&nbsp;Error!</strong> Seleccione El color de la facultad.</center></div>");
				return false;
				}else if( nom == "" ){
