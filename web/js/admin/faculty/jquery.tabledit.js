...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            inputClass: 'form-control  form-control validate inputp',
                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                ...
                                var input = '<input class="tabledit-input jscolor{borderColor:' + "'#FFF'" + ', insetColor:' + "'#FFF'" + ', backgroundColor:' + "'#142b3b'" + '} cpick' + settings.inputClass + '" type="text" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
